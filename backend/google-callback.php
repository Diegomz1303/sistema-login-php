...
// Si Google nos devuelve un código, lo usamos para obtener el token de acceso
if (isset($_GET['code'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Nota: No guardamos contraseña, ya que la autenticación la gestiona Google
    ...
    // Si no hay código, redirigimos a la página de login
